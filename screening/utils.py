...
def calculate_score(session):
    responses = ScreeningResponse.objects.filter(session=session).select_related(
...
def get_severity(questionnaire_name, score):
    ...
    thresholds = SEVERITY_MAP.get(
        questionnaire_name, [(4, "Minimal"), (9, "Mild"), (14, "Moderate"), (999, "Severe")]
    )
...
def get_recommendations(questionnaire_name, severity):
    recs = {
        ...
        "CBI-W": {
            "Low": [
                "Your work-related burnout levels are low.",
                "Maintain your current work-life balance practices.",
                "Regular breaks and boundaries help prevent burnout.",
            ],
            "Moderate": [
                "Your results suggest moderate work-related burnout.",
                "Consider reviewing your workload with your manager.",
                "Ensure you are taking adequate breaks during the workday.",
                "Practice boundary-setting between work and personal time.",
            ],
            "High": [
                "Your results suggest high work-related burnout.",
                "We recommend discussing workload adjustments with your HR department.",
                "Consider speaking with a mental health professional.",
                "Prioritize rest and recovery outside of work hours.",
            ],
            "Severe": [
                "Your results suggest severe work-related burnout.",
                "Please speak with your manager or HR about immediate support.",
        ...
        "WHO-5": {
            "Poor": [
                "Your well-being score suggests room for improvement.",
                "Consider speaking with a mental health professional.",
                "Focus on self-care, sleep, and physical activity.",
            ],
            "Fair": [
                "Your well-being is moderate.",
                "Consider activities that boost your mood and energy.",
                "Stay connected with supportive people.",
            ],
            "Good": [
                "Your well-being is good.",
                "Continue your current healthy habits.",
                "Maintain social connections and physical activity.",
            ],
            "Excellent": [
                "Your well-being is excellent.",
        ...
        "K6": {
            "Low": [
                "Your psychological distress levels are low.",
                "Continue your current coping strategies.",
                "Stay connected with your support network.",
            ],
            "Moderate": [
                "Your results suggest moderate psychological distress.",
                "Consider speaking with a counselor.",
                "Practice stress-reduction techniques like meditation or deep breathing.",
            ],
            "Severe": [
                "Your results suggest serious psychological distress.",
                "Please seek professional help as soon as possible.",
                "Contact a mental health crisis line if needed.",
                "Reach out to your HR department for support resources.",
            ],
        },
        "Work Stress": {
            "Low": [
                "Your work stress levels are low.",
                "Continue your current stress-management practices.",
                "Maintain healthy work boundaries.",
            ],
            "Mild": [
                "Your results suggest mild work-related stress.",
                "Identify specific stressors and address them proactively.",
                "Practice relaxation techniques during the workday.",
                "Consider discussing concerns with your manager.",
            ],
            "Moderate": [
                "Your results suggest moderate work-related stress.",
                "We recommend speaking with your manager about workload or role clarity.",
                "Consider mindfulness or stress-management programs.",
                "Ensure you are taking regular breaks and time off.",
            ],
            "Severe": [
                "Your results suggest severe work-related stress.",
                "Please speak with your HR department about support options.",
                "Consider taking time off to address stress levels.",
                "Consult with a healthcare professional.",
            ],
        },
        "WPAI": {
            "Minimal": [
                "Your work productivity impact is minimal.",
                "Continue managing your health effectively.",
                "Maintain your current work habits.",
            ],
            "Mild": [
                "Your health has a mild impact on productivity.",
                "Consider strategies to manage symptoms at work.",
                "Speak with your manager about flexible work options if needed.",
            ],
            "Moderate": [
                "Your health is moderately impacting your productivity.",
                "Consider discussing workplace accommodations with HR.",
                "Review your workload and prioritize tasks.",
                "Consult with a healthcare professional about managing symptoms.",
            ],
            "Severe": [
                "Your health is severely impacting your productivity.",
                "Please speak with HR about support and accommodations.",
                "Consider taking time off to focus on recovery.",
