...
from . import psychiatrist, views
...
urlpatterns = [
    ...
    # Campaigns
    path(
        "campaigns/<int:pk>/sessions/",
        views.CampaignViewSet.as_view({"get": "sessions"}),
    ...
    path(
        "psy/companies/<int:company_id>/",
        psychiatrist.psy_company_detail,
        name="psy-company-detail",
    ),
    path(
        "psy/companies/<int:company_id>/grading/",
        psychiatrist.psy_grading_config,
        name="psy-grading",
    ),
    path(
        "psy/companies/<int:company_id>/analytics/",
        psychiatrist.psy_company_analytics,
        name="psy-analytics",
    ),
